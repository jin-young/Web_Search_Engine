...
public class Spearman {
	...
	public static void main(String[] args) throws IOException{
		loadnumview("/Users/soo/Desktop/Web_Search_Engine/data/index/numView.dat");
	/*	if(args.length!=2){
			System.out.println("Please provide 2 parameters");
		}
		else{
			Map<String, Document> numview=(Map<String, Document>) loadnumview(args[1]);
		...
		//Map<String, Document> pagerank=(Map<String, Document>) loadpagerank("data/index/pagRank.dat");
