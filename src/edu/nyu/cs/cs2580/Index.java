...
class Index {
	...
	// # of docs which s occurs in.
	public int documentFrequency(String s) {
		return Document.documentFrequency(s);
	}

	// # of ocurrences of s in the entire collections
	public int termFrequency(String s) {
		return Document.termFrequency(s);
	}

	// # of words occurrences in the collection
	// the sum of termFrequency(s) over all words in the vocabulary
