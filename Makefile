...
TEST_LIBS:=./libs/cglib-nodep-2.2.3.jar:./libs/jsoup-1.7.2.jar:./libs/objenesis-1.3.jar:./libs/easymock-3.1.jar:./libs/junit_4.10.0.jar:./libs/org.hamcrest.core_1.1.0.v20090501071000.jar:./libs/gson-2.2.3.jar

compile:
	javac -classpath ./src:./libs/jsoup-1.7.2.jar:./libs/gson-2.2.3.jar $$($(SOURCES))
